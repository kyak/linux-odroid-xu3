...
_commit=6ad91098731467228513597d84cc53aa332b4344
_srcname=linux-odroid-${_commit}
_kernelname=${pkgbase#linux}
_desc="ODROID-XU3/XU4/HC1"
pkgver=4.14.336
pkgrel=1
arch=('armv7h')
url="https://github.com/kyak/linux-odroid"
license=('GPL2')
...
source=("https://github.com/kyak/linux/archive/${_commit}.tar.gz"
        ...
        '0005-add-modules.builtin.modinfo.patch'
        'config'
        'linux.preset'
        '99-linux.hook')
md5sums=('358c051619355e1c0885a7d1c1428055'
...
prepare() {
  ...
  patch -Np1 -i ../0002-rtl8812au-unused-spinlock-free.patch
  patch -Np1 -i ../0003-rtl8812au-ssid-always-not-null.patch
  patch -Np1 -i ../0004-rtl8812au-comparision-true.patch
  patch -Np1 -i ../0005-add-modules.builtin.modinfo.patch
